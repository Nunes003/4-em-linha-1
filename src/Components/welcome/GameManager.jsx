...
export default function GameManager() {
  ...
  const [player3Piece, setPlayer3Piece] = useState('');
  ...
  const validatePlayers = () => {
    if (selectedMode === '1vs1') {
      ...
      // Sorteia peças diferentes para cada jogador
      const [piece1, piece2] = getRandomPieces(2);
      setPlayer1Piece(piece1);
      setPlayer2Piece(piece2);
      setPlayer3Piece(''); // não usado nesse modo
    }
    ...
    if (selectedMode === '1vsPC') {
      ...
      // Sorteia peças diferentes para jogador e computador
      const [piecePlayer, piecePC] = getRandomPieces(2);
      setPlayer3Piece(piecePlayer);
      setPlayer2Piece(piecePC);
      setPlayer1Piece(''); // não usado nesse modo
    }
